...
Download the [v2.2.2 `skill.zip`](https://github.com/quocbao201104/marketing-agent-skills/releases/download/v2.2.2/skill.zip), or build from the tagged source using the command below. The host-specific import limits below still apply.
