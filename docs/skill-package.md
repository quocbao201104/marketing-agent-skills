...
Download the [v2.0.0 skill ZIP](https://github.com/quocbao201104/marketing-practitioner/releases/download/v2.0.0/marketing-practitioner.zip), or build from the tagged source using the command below. The host-specific import limits below still apply.
