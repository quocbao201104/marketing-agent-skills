...
Reviewed the processing, identity, commercial-state, eligibility, representation, and diagnosis guidance in [the Google module](../../skills/marketing-agent-skills/platforms/commerce/google-shopping.md), with [SKILL.md](../../skills/marketing-agent-skills/SKILL.md), the relevant distinctions in [Chapter 09](../../skills/marketing-agent-skills/handbook/09-commerce-environments-and-product-discovery.md), and [G01-G11](../../skills/marketing-agent-skills/references/commerce/google-shopping-evidence.md) as context. Inspected actual `google-commerce.processing`, `google-commerce.identity`, and `google-commerce.diagnosis` loader output.
