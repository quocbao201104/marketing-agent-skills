...
Target: the delegation condition in [SKILL.md](../skills/marketing-agent-skills/SKILL.md#conditional-support) and [Coordinating subagents when useful](../skills/marketing-agent-skills/references/work-coordination.md#coordinating-subagents-when-useful), read with the core continuity, evidence, authority, and uncertainty rules. These cases exercise optional coordination inside marketing work; they do not require a particular host tool, model, agent count, or visible workflow template.
